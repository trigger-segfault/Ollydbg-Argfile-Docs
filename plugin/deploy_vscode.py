#!/usr/bin/env python3
#-*- coding: utf-8 -*-
"""Deploy finished changes in vscode-ollydbg-arg plugin to VSCode extensions directory
"""
...
EXTENSION_DIR:str = r".vscode/extensions/vscode-ollydbg-arg"
...
PLUGIN_PATH:str = os.path.join(SCRIPT_DIR, r"vscode-ollydbg-arg")
...
def main(argv:list=None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description='deploy changes to vscode-ollydbg-arg extension',
        add_help=True)
